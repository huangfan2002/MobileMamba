...
# Course-report long training switch: set True for KD/long-cycle reproduction.
long_train = False
if long_train:
	epoch_full = 1000
	test_start_epoch = 800
...
# =========> model <=================================
model = _Namespace()
model.name = 'MobileMamba_B4_MRFFI'
...
trainer.checkpoint = 'runs/mobilemamba_mrffi_course'
trainer.resume_dir = ''
...
trainer.scale_kwargs = dict(n_scale=0, base_h=size, base_w=size, min_h=384, max_h=512, min_w=384, max_w=512, check_scale_div_factor=32)
